...
\begin{itemize}
    \item Tajnost
        \begin{itemize}
            \item informcija nije dostupna ili izložena  neovlaštenim osobama, entitetima ili procesima
        \end{itemize}
    \item Cjelovitost
        \begin{itemize}
            \item točnost i potpunost informacije
        \end{itemize}
    \item Raspoloživost
        \begin{itemize}
            \item informacija je dostupna na zahtjev i omogućeno je njeno korištenje od strane ovlaštenih osoba, entiteta ili procesa
        \end{itemize}
    \item Vjerodostojnost
        \begin{itemize}
            \item osoba, entitet ili proces je zaista onaj kojim se predstavlja
        \end{itemize}
    \item Odgovornost
        \begin{itemize}
            \item obveza izvještavanja o aktivnostima i preuzimanja odgovornosti za njih
        \end{itemize}
    \item Neporicanje
        \begin{itemize}
            \item sposobnost dokazivanja događaja ili aktivnosti i osoba, entiteta ili procesa koji su ih pokrenuli ili u njima sudjelovali
        \end{itemize}
    \item Pouzdanost
        \begin{itemize}
            \item konzistentno ponašanje i rezultati
        \end{itemize}
\end{itemize}
