...
\begin{table}[h]
    \centering
    \caption{Komparacija pristupnih uređaja}
    \begin{tabular}{|L|L|L|L|L|L|} 
    \hline
    \textbf{Pristupni uređaj} & \textbf{Povezanost} & \textbf{Nešto} & \textbf{Sigurnosni mehanizmi} & \textbf{Primjena} & \textbf{Nešto drugo}\\
    \hline\hline
    Raspberry Pi 4 Model B & da & da & da & da & da\\
    \hline
    Raspberry Pi Pico & da & da & da & da & da\\
    \hline
    Arduino Uno Rev3 & da & da & da & da & da\\
    \hline
    Libelium Waspmote & da & da & da & da & da\\
    \hline
    ESP32 & da & da & da & da & da\\
    \hline
    Pycom FiPy & da & da & da & da & da\\
    \hline
    \end{tabular}
    \label{tab:devices}
\end{table} 
