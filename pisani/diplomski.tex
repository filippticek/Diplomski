...
\begin{table}[H]
    ...
    \hline
    \textbf{{Šifriranje}}     &  RC4 & TKIP s RC4 & AES-CCMP & AES-CCMP AES-GCMP\\ 
    \hline
    \textbf{Veličina ključa}  & 64 bita \hspace{0.2cm}128 bita & 128 bita &  128 bita & 128 bita \hspace{1cm}256 bita\\ 
    \hline
...
%Tijek OTAA aktivacijskog postupka je prikazan na slici x.x.
\begin{enumerate}
...
%Add image and fix issue with citation being broken
%\begin{figure}[H]
%    \centering
%    \includegraphics[width=13cm]{images/otaa.png}
%    \caption{Tijek OTAA postupka\citep{LoRaWANAct}}
%    \label{fig:otaa}
%\end{figure}
...
%Opisati općenito sustav, cilj, svrha, itd.
